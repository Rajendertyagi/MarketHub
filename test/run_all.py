...
_TEST_FILES: dict[str, str] = {
    ...
    "mcp_live_consumer_notifications": "test_mcp_live_consumer_notifications.py",
    ...
    "mcp_3e_reconnect_restart": "test_mcp_3e_reconnect_restart.py",
...
GROUPS: dict[str, list[str]] = {
    ...
    "mcp": ["subscriptions", "mcp_live_consumer_notifications", "sdk_alignment", "lifespan", "multi_client", "errors", "timeouts", "sse_stream"],
