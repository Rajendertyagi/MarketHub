        ...
        <tbody>
          {alerts.map((a) => (
            <tr key={a.id}>
              ...
              <td className="num">{formatCondition(a.field, a.operator, a.threshold)}</td>
              <td>
                <span
                  className={`chip ${a.state === "triggered" ? "chip-off" : a.enabled ? "chip-on" : ""}`}
                >
                  {a.state}
                </span>
              </td>
              <td>
                <label className="switch">
                  <input
                    type="checkbox"
                    checked={a.enabled}
                    onChange={(e) => m.setEnabled({ id: a.id, enabled: e.target.checked })}
                  />
                </label>
              </td>
              <td>
                ...
                <Button className="btn-compact btn-outline-danger" onClick={() => m.remove(a.id)}>
                  ✕
                </Button>
              </td>
            </tr>
