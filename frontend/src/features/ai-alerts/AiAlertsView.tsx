  ...
  return (
    <div className="panel">
      <div className="page-header">
        ...
        <span className="muted">Read-only observability over durable alert state</span>
        <Button
          className="btn-compact"
          onClick={() => qc.invalidateQueries({ queryKey: ["ai-alerts"] })}
        >
          Refresh
        </Button>
      </div>

      <Tabs<AiTab> tabs={TABS} active={tab} onChange={setTab} />
